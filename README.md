...
To build the code, you MSST have CubeIDE V2.1 or later. Unzip the project file, open CubeIDE with a blank workspace, then import the pre-built
projects into it. Open the .ioc file with CubeMX, and generate the code. Then return to CubeIDE and build it. The Nucleo will generate an object
file that can be downloaded, and the Pi Zero will generate a .bin file which can be flashed using STM32Flash.
